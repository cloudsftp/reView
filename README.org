...
#+begin_src shell
sudo apt install gcc pkg-config libglib2.0-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev
#+end_src

*** openSUSE

#+begin_src shell
sudo zypper in gcc pkg-config glib2-devel gstreamer-devel gstreamer-plugins-base-devel
#+end_src
